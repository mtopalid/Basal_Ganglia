...
connections = {
    ...
    "STN.cog -> GPI.cog" : OneToAll( STN.cog.V, GPI.cog.Isyn, np.ones(4)  ),
    "STN.mot -> GPI.mot" : OneToAll( STN.mot.V, GPI.mot.Isyn, np.ones(4)  ),
    #new#"STN.cog -> GPE.cog" : OneToAll( STN.cog.V, GPI.cog.Isyn, np.ones(4)  ),
    #new#"STN.mot -> GPE.mot" : OneToAll( STN.mot.V, GPI.mot.Isyn, np.ones(4)  ),
    ...
    #new#"GPE.cog -> GPI.cog" : OneToOne( STR.cog.V, GPE.cog.Isyn, np.ones(4)  ),
    #new#"GPE.mot -> GPI.mot" : OneToOne( STR.mot.V, GPE.mot.Isyn, np.ones(4)  ),
    "GPI.cog -> THL.cog" : OneToOne( GPI.cog.V, THL.cog.Isyn, np.ones(4) ),
    "GPI.mot -> THL.mot" : OneToOne( GPI.mot.V, THL.mot.Isyn, np.ones(4) ),
    #new#"THL.cog -> GPI.cog" : OneToOne( THL.cog.V, CTX.cog.Isyn, np.ones(4)  ),
    #new#"THL.mot -> GPI.mot" : OneToOne( THL.mot.V, CTX.mot.Isyn, np.ones(4)  ),
